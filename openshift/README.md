...
```bash
export GIT_URI="https://github.com/bcgov/gcpe-NRMS-frontend.git"
...
https://nrms-frontend-nrms-dev.pathfinder.gov.bc.ca/

After:

https://nrms-frontend-nrms-dev.10.0.75.2.nip.io/
